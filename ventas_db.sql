...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2022 a las 13:53:13
...
CREATE TABLE `producto` (
  ...
  `precio` decimal(10,2) NOT NULL,
  `porcentaje_recargo` decimal(10,2) NOT NULL,
  `codigo_barra` varchar(350) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `producto` (`codproducto`, `codigo`, `descripcion`, `precio`, `porcentaje_recargo`, `codigo_barra`, `existencia`) VALUES
(2, '112323121212', 'Pilas AAA', '125.00', '45.00', '', 20);
